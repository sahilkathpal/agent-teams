...
Return a single JSON object matching the MetaAgentOutput schema:
```json
{
  "run_id": "{{run_id}}",
  ...
  "prompt_updates": {
    "add": [
      { "prompt": "...", "cluster": "cluster-name", "reason": "...", "source": "geo_target|adjacent_query|competitor_gap|manual", "expected_volume": "high|medium|low|unknown" }
    ],
    "retire": [
      { "prompt": "...", "reason": "..." }
    ],
    "recluster": [
      { "prompt": "...", "from_cluster": "old-cluster|null", "to_cluster": "new-cluster", "reason": "..." }
    ]
  },
  "strategy_notes": ["..."]
}
